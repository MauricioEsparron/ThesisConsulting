...
const CulturaOrganizacional = () => {
  return (
    ...
    >
      ...
      >
        <p>
          En <strong>Thesis Consulting</strong> valoramos la curiosidad, la
          excelencia y la colaboración. Nuestro equipo multidisciplinario
          trabaja con pasión para transformar investigaciones académicas en
          proyectos que generen impacto real y sostenible.
        </p>
        <motion.p
